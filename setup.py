...
exe = Executable(
 # what to build
   script = "Wuhan_coV.py", # the name of your main python script goes here 
   initScript = None,
   base = None, # if creating a GUI instead of a console app, type "Win32GUI"
   targetName = "Wuhan_coV_summary.exe", # this is the name of the executable file
   icon = None # if you want to use an icon file, specify the file name here
)


setup(  name = "Wuhan_coV",
		version = "0.1",
